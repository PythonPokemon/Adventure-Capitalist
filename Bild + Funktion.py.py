...
# Fenstergröße
window_size = [1000, 700]  # Erhöhe die Höhe des Fensters, um den Platz für die Scrollfunktion zu haben
...
pygame.display.set_caption("Scroll-Fenster mit Hintergrundbild")

# Hintergrundbild laden und auf gewünschte Größe skalieren
background_image = pygame.image.load('background.png')
background_image = pygame.transform.scale(background_image, (1000, 400))

# Schriftart initialisieren
font = pygame.font.SysFont(None, 25)

# Texte für den unteren Teil
lower_text = "Dieser Teil ist scrollbar.\nBenutze das Mausrad zum Scrollen."
...
while running:
    ...
    # Hintergrundbild im oberen Teil anzeigen (fest)
    screen.blit(background_image, (0, 0))

    # Texte zeichnen
    lower_text_rendered = font.render(lower_text, True, (0, 0, 0))

    # Unteren Text positionieren mit Berücksichtigung der Scroll-Position
    lower_text_pos = (window_size[0] // 2 - lower_text_rendered.get_width() // 2, 400 + scroll_y)

    # Texte auf den Bildschirm zeichnen
    screen.blit(lower_text_rendered, lower_text_pos)

    # Knöpfe und Balken zeichnen
